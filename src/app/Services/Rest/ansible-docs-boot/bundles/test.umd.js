(function (global, factory) {
	...
	(factory((global.test = {}),global.ng.core,global.ng.common.http));
...
var AnsibleCommandDetailerControllerService = /** @class */ (function () {
    ...
    AnsibleCommandDetailerControllerService.prototype.getCommandDetailsByModuleNameAndSubModuleNameAndCommand = function (moduleName, command, subModuleName, observe, reportProgress) {
        ...
        var /** @type {?} */ queryParameters = new http.HttpParams({ encoder: new CustomHttpUrlEncodingCodec() });
...
exports.APIS = APIS;
exports.AnsibleCommandDetailerControllerService = AnsibleCommandDetailerControllerService;
